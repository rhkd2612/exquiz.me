...
public class SubjectiveProblem extends Problem {
    ...
    private static ProblemOptionDto createProblemOptionDtoByString(String curDescription) {
        return new ProblemOptionDto(curDescription);
    }
}
